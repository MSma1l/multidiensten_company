...
export const translations = {
  nl: {
    ...
    jobs: {
      ...
      levels: { junior: 'Junior', middle: 'Medior', senior: 'Senior' },
      experience: 'Werkervaring',
      allExperience: 'Alle ervaring',
      yearsUnit: 'jaar',
      hours: 'Uren per week',
      allHours: 'Alle uren',
      hoursUnit: 'uur',
      ...
      sortSalaryDesc: 'Salaris: hoog naar laag',
      sortSalaryAsc: 'Salaris: laag naar hoog',
      fullTime: 'Fulltime',
      apply: 'Solliciteren',
  ...
  en: {
    nav: { home: 'Home', jobs: 'Opportunities', contact: 'Get in touch' },
    ...
    jobs: {
      ...
      levels: { junior: 'Junior', middle: 'Mid-level', senior: 'Senior' },
